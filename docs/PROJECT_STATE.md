...
### Preserved third rights-cleared plate/text sample
Washington is now measured without tuning. Admission run #208 bound source SHA-256 `265046b1e374d1a457658308e75f713aa3796c44092f3f8173930d3a7aa17a09` plus canonical 3200x910 RGB24 crop SHA-256 `0e4655be2fe57d47c890855cf22371ff2b7ab764cfc9c1084a692a9ee67d8bca`. Exact-head run #209 passed Linux, Windows, the bounded OCR evidence step and the Analytics quality gate; post-merge run #210 also passed. The unchanged retained Tesseract/Otsu path returned `CPU404` at confidence 0.39522404 versus expected `CPU4704` (`exact_match=false`), Otsu threshold 119, OCR elapsed 1.290732 s.

Across the three independently bound CC0 samples, Tesseract now shows three materially different failure modes: extra surrounding characters (`IFMPR318J` vs `MPR318`), an inserted character (`354AVIV` vs `354AVV`) and a dropped character (`CPU404` vs `CPU4704`). Do not add a cosmetic normalization rule to this baseline; the evidence no longer supports treating the remaining defect as one simple post-processing error.

### OCR replacement donor screen — closed at three
The replacement recognizer screen is closed at the policy maximum of three candidates:
1. Open Model Zoo `text-recognition-resnet-fc` at OMZ `6697dead54ed1cdd664b0313189c2cb52ee6335e`, sourced from VedaSTR `0fd2a0bd7819ae4daa2a161501e9f1c2ac67e96a`; published checkpoint 712,199,075 bytes, SHA-384 `731cfa8125b4176f3ee668dd78d8f4dc964dc2e60bd1959e07931804a59292c10c94bee6548ee50b8626b09b8f442d07`, Apache-2.0. The exact VedaSTR training config consumes MJ/MJSynth and ST/SynthText. Current upstream dataset pages do not close the explicit commercial training/redistribution rights required here, so reject from the shippable path.
2. Open Model Zoo `text-recognition-0012` FP16 at the same OMZ revision; XML SHA-384 `f7a92c5ef476dc8fcb9d33471e3f42129651ae859871c00e5872350113b08acb6feeede4f09279e35168956c3161dad2`, BIN SHA-384 `32515346d0c40c78f8854bed5499a7cdc0ae9620db1afac06fa2db87dab4e9c2381213cfb08061e220c8075c25731dce`, Apache-2.0. Published model documentation does not identify the training corpus/provenance strongly enough to satisfy the required data/weight lineage, so reject for now.
3. Open Model Zoo `text-recognition-0014` FP16; XML SHA-384 `fe8075e338c8ba2535934f175c4a36a147396792c205291887a9d892c04aa6152715cda5c51ac7d6c41d52f3e9ab7c60`, BIN SHA-384 `1c3b20d22ec03a451262e47804be78783c21daced4bd9532516f0b75f439d5ce3fe8f06da107f4320f0bebf01fca5d46`, Apache-2.0. Exact training-data provenance and commercial rights are not disclosed strongly enough for the fail-closed policy, so reject for now.

### Current acceptance item — project-authored glyph OCR fallback
Change approach rather than spend a fourth session tuning Tesseract. The current candidate is project-authored and uses only already-reviewed OpenCV primitives: Otsu inversion, bounded connected-component segmentation, a deterministic in-memory template bank generated with OpenCV Hershey vector fonts across four font families / three thicknesses / three small rotations / three horizontal stretches, normalized glyph comparison, and a fixed predeclared minimum template score of 0.30. It downloads no OCR model, uses no external weights, uses no training dataset, and adds no new runtime family.
