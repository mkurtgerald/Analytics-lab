"""Bounded third-source LPR/OCR evidence on one CC0 Washington plate.
...
_RIGHTS_PAGE = (
    ...
    "File:CPU4704_Unembossed_Washington_License_Plate.jpg"
    "&oldid=1269104394"
)
_SOURCE_URL = (
    "https://upload.wikimedia.org/wikipedia/commons/7/7e/"
    "CPU4704_Unembossed_Washington_License_Plate.jpg"
)
...
def run(work_dir: Path) -> dict[str, object]:
    if os.name != "nt":
        raise RuntimeError("Washington exact OCR evidence requires Windows")
